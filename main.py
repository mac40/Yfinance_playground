...
if __name__ == "__main__":
    ...
    op.test_model("^SPX", 2, 2, 1, period='1y')
    op.plot_prediction("^SPX", 2, 2, 1, future=30, period='1y')
    ...
    # op.test_model("NVDA", 1, 1, 1, period='1y')
    ...
    # op.test_model("MSFT", 2, 2, 1, period='1y')
    # op.plot_prediction("MSFT", 2, 2, 1, future=30, period='1y')
